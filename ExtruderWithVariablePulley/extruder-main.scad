...
difference(){
    ...
    union(){
        ...
        difference(){
         translate([-15.5,40,0])cube([21.5,8,14]);
         translate([9,41+3,-1]) rotate([0,0,45]) translate([0,-5,-0.1]) cube([10,12,20]);    
        }
    ...
    translate([-28.5,40,5]) rotate([0,30,0]) translate([0,-5,-0.1]) cube([10,12+3,20]);   // Top
    translate([-33,40,-5]) rotate([0,60,0]) translate([0,-5,-0.1]) cube([12,12+3,20]); // Bottom
    
    PindaXOff=-0;
    // P.I.N.D.A. probe mount hole
     translate([35/2+PindaXOff,0,6]){
    ...
    translate([35/2+DriveGearOff,0,15]) rotate([-90,0,0]) cylinder(r=7.13, h=20, $fn=120);
...
difference(){
    ...
    // Fins up
        ...
        // Structural support
        translate([-2,13,13]) rotate([0,45,0]) cube([15,30,1]);
        //translate([0,13,14.5]) rotate([0,0,0]) cube([4,30,0.5]);
    }
    // Trim
    translate([-35,0,0])cube([35,43,15]);
     translate([35/2+DriveGearOff,13,15]) rotate([-90,0,0]) cylinder(r=11.53, h=33.001, $fn=80);
...
//  Filament visualisation
    %translate([-35/2-DriveGearOff,-50,15])rotate([-90,0,0])cylinder(r=1.75/2, h=100, $fn=20);
...
difference(){
    ...
    translate([-15-DriveGearOff,-49.5,-1]) cube([42,23,32]);
    translate([-51,-33,-1]) rotate([0,65,0]) cube([10,25,10]);
    translate([-35/2+3+1.8+0.5-DriveGearOff,-41,2+3+2.5])cube([42,42,32]);
    //base round cutout
    translate([-21,-21,-2]) cylinder(r=11.5, h=33, $fn=200);
    
    //filament hole
    translate([-35/2-DriveGearOff,-42,15])rotate([-90,0,0])cylinder(r=2.5/2, h=20, $fn=20);
    translate([-35/2-DriveGearOff,-42,15])rotate([-90,0,0])cylinder(r2=2.2/2,r1=3.6/2, h=1.5, $fn=20);
}

//filament guide
translate([-35/2-3-DriveGearOff,-19,15-4])cube([6,10,6.5]);
difference(){
union(){
translate([-35/2-3-DriveGearOff,-8.4+2+1.2,0.4]) rotate([45,0,0]) cube([6,15,15]);
translate([-35/2-3-DriveGearOff,-8.4+2+1.2,0.4+6.5]) rotate([45,0,0]) cube([6,15,15]);    
}
translate([-35/2-4-DriveGearOff,-1,2]) cube([8,15,25]);
    ...
    // Filament ptfe guide cutout
        ...
        translate([-35/2-DriveGearOff,-3.99,15])rotate([-90,0,0]) cylinder(r=7.5/2, h=5, $fn=50);    // Bottom hole
        translate([-35/2-DriveGearOff,-3.99,21])rotate([-90,0,0]) cylinder(r=7.5/2, h=5, $fn=50);    // Top hole     
        translate([-35/2 - 7.5/2-DriveGearOff,-3.99,21])rotate([-90,0,0])cube([7.5,6,8]);            // Slot cut
    
        // PTFE tube slot
        translate([-35/2-DriveGearOff,-23,15])rotate([-90,0,0]) cylinder(r=4.3/2, h=25, $fn=50);     // Main hole
        translate([-35/2-DriveGearOff,-9,15])rotate([-60,0,0]) rotate([0,0,10])cylinder(r=4.3/2, h=25, $fn=50); // Top hole
        // Slot cut
        difference(){
        translate([-35/2-DriveGearOff,-8,14])rotate([-60,0,0]) rotate([0,0,30])cylinder(r=4.85/2, h=25, $fn=6);
        translate([-22-DriveGearOff,-20,5])cube([10,50,10]);
        }
        
       // drive pulley cutout
           translate([-21-DriveGearOff,-21,8])cylinder(r=4, h=13, $fn=80);
       // idler bearing cutout
           translate([-21+13-DriveGearOff,-21,8])cylinder(r=8.5, h=13, $fn=80);

             translate([-21-DriveGearOff,-27,8])cube([10,10,13]); // Trim
...
difference(){
 ...
 module extruder_mount_holes(){
     ...
     //Pinda cable
     translate([-0.7,22.5,0])cylinder(r=2.5, h=15, $fn=30); 
...
translate([21,-21,0]){
 ...
 module extruder_nozzle_cut(){
     ...
     //Nozzle cutout
    // Top
    translate([35/2+DriveGearOff,-0.001,15]) rotate([-90,0,0]) cylinder(r=8.13, h=3.7+0.5, $fn=120);
    // Groove
    translate([35/2+DriveGearOff,0,15]) rotate([-90,0,0]) cylinder(r=6.13, h=20, $fn=120);
    // Bottom
    translate([35/2+DriveGearOff,9.8,15]) rotate([-90,0,0]) cylinder(r=8.13, h=3.7, $fn=120);
    // Main body
    translate([35/2+DriveGearOff,13,15]) rotate([-90,0,0]) cylinder(r=11.53, h=45.001, $fn=80);
