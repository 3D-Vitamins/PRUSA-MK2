...
module x_carriage_base(){
 ...
 translate([-33/2,0,0]) rotate([0,0,90]) horizontal_bearing_base(1.02);
 // Long bearing holder
 translate([-33/2,45,0]) rotate([0,0,90]) horizontal_bearing_base(2.1);
 // Base plate
 ...
 translate([-16.5+12,24.5,14])cylinder(r1=4.5, r2=3.8, h=2, $fn=25);
  ...
  // Endstop trigger nipple
     difference(){  
     union(){
       // Enlarged Endstop nipple because of Igus Bushings  
       translate([-2.5,-16,0]) cube([13,5.8,12]);
...
module x_carriage_holes(){
 ...
 // Changes for IgusEnclosed bushings which have slight overhanging inlays   
 // Small bearing holder holes cutter
 translate([-33/2,0,0]) rotate([0,0,90]) horizontal_bearing_holes(1.05);
 // Long bearing holder holes cutter
 translate([-33/2,45,0]) rotate([0,0,90]) horizontal_bearing_holes(2.07);
  ...
  // Carriage slimer
    translate([-55.5+2.5,19,-1])cube([10,40,30]);
    translate([+12.5-2.5,19,-1])cube([10,40,30]);
    
    translate([+12.5-3.5-1.5,19,-1])rotate([0,90-65,0])cube([10,55,30]);
    translate([-55.5+6.7+1.5,19,-10])rotate([0,-90+65,0])cube([10,40,30]);
